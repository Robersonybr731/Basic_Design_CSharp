...
namespace WP_12_3
{
    public partial class Form1 : Form
    {
        ...
        private void 開啟舊檔ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void 負片ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ColorMatrix cm = new ColorMatrix(
        ...
        private void 灰階ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ColorMatrix cm = new ColorMatrix(
